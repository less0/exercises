...
This file is an addendum to the architecture documentation and serves the purpose to define the communication interfaces between the components of the application. The basic means of communication are described in the architecture document, this documents describes the exchanges messages in a greater depth.
